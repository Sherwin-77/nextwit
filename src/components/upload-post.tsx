...
function SubmitButton() {
    ...
    return (
        <button className="bg-indigo-300 dark:bg-sky-700 hover:bg-white dark:hover:bg-sky-500 dark:text-white text-black py-3 px-8 rounded-full disabled:opacity-75" aria-disabled={pending} disabled={pending}>
